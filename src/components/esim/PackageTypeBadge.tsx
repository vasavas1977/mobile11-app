...
import { Sun, Gauge, Zap, LucideIcon, Info } from 'lucide-react';
...
export function PackageTypeBadge({ 
  packageType, 
  size = 'md', 
  showIcon = true,
  showTooltip = true,
  ...
  // Safety check in case of unexpected package types
  if (!config) {
  ...
  // Subtitle color based on package type and selection state
  ...
  // Rich Popover tooltip with "Why [Plan Type]?" content (click-triggered for better mobile UX)
  return (
    <Popover>
