-- Schedule the auto-retry function every 5 minutes
SELECT cron.schedule(
  'auto-retry-stuck-usimsa-orders',
  '*/5 * * * *',
  $$
  SELECT
    net.http_post(
      url := 'https://jaqyvbjllsanrnpzlyjw.supabase.co/functions/v1/auto-retry-stuck-orders',
