...
INSERT INTO kb_articles (
  category, title, slug, description, content, language, is_published, is_internal, tags, table_of_contents
) VALUES (
  'about-mobile11',
  'Priority vs Economy Class – What''s the Difference?',
  'priority-vs-economy-class',
  'Learn the differences between Priority and Economy service tiers, including speed, coverage, pricing, and which one is right for you.',
  '## Overview {#overview}
...
Economy class is **30% cheaper** than Priority for the same package. For example, if a Priority plan costs $30, the Economy version would be $21.',
  ...
  true,
  false,
  ARRAY['priority', 'economy', 'service tier', 'pricing', 'comparison'],
  '[{"id":"overview","title":"Overview"},{"id":"priority-class","title":"Priority Class"},{"id":"economy-class","title":"Economy Class"},{"id":"comparison-table","title":"Side-by-Side Comparison"},{"id":"how-to-choose","title":"How to Choose Your Tier"},{"id":"faq","title":"Frequently Asked Questions"}]'::jsonb
);
...
INSERT INTO kb_articles (
  ...
  'about-mobile11',
  'Priority vs Economy Class – แตกต่างกันอย่างไร?',
  'priority-vs-economy-class',
  'เรียนรู้ความแตกต่างระหว่าง Priority และ Economy รวมถึงความเร็ว ความครอบคลุม ราคา และแพ็กเกจไหนเหมาะกับคุณ',
  '## ภาพรวม {#overview}
...
Economy class **ถูกกว่า 30%** เทียบกับ Priority สำหรับแพ็กเกจเดียวกัน เช่น ถ้า Priority ราคา $30 Economy จะราคา $21',
  ...
  true,
  false,
  ARRAY['priority', 'economy', 'ระดับบริการ', 'ราคา', 'เปรียบเทียบ'],
  '[{"id":"overview","title":"ภาพรวม"},{"id":"priority-class","title":"Priority Class"},{"id":"economy-class","title":"Economy Class"},{"id":"comparison-table","title":"เปรียบเทียบแบบเคียงข้างกัน"},{"id":"how-to-choose","title":"วิธีเลือกระดับบริการ"},{"id":"faq","title":"คำถามที่พบบ่อย"}]'::jsonb
);
